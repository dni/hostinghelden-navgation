<?php
namespace Hostinghelden\Navigation\Model\Category\Attribute\Backend;

class Icon extends \Magento\Catalog\Model\Category\Attribute\Backend\Image
{
  ...
  private function getImageUploader()
  {
    if ($this->imageUploader === NULL) {
      $this->imageUploader = \Magento\Framework\App\ObjectManager::getInstance()->get(
        'Hostinghelden\Navigation\CategoryIconUpload'
      );
    }
